        ...
        <div class="bg-light rounded-4 shadow p-4">
            <div class="row justify-content-center g-4 py-3">
                <div class="col-12 col-md-6 col-lg-5">
                    <a href="{{ route('dashboard-guru.hasil-belajar') }}" class="text-decoration-none text-dark">
                        <div class="card shadow-sm border-0 h-100 bg-white text-center rounded-4 py-5">
                            <div class="card-body d-flex flex-column align-items-center justify-content-center">
                                ...
                                <h4 class="card-title fw-bold">Hasil Belajar Siswa</h4>
                            </div>
                        </div>
                    </a>
                </div>
                <div class="col-12 col-md-6 col-lg-5">
                    <a href="{{ route('dashboard-guru.akunSiswa') }}" class="text-decoration-none text-dark">
                        <div class="card shadow-sm border-0 h-100 bg-white text-center rounded-4 py-5">
                            <div class="card-body d-flex flex-column align-items-center justify-content-center">
                                <i class="bi bi-person-lines-fill display-3 text-success mb-3"></i>
                                <h4 class="card-title fw-bold">Akun Siswa</h4>
                            </div>
                        </div>
                    </a>
                </div>
